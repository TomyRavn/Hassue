...
<!--         <nav class="navbar navbar-expand-sm navbar-dark bg-dark id="mainNav"> -->
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">hassue</a>
		...
		<section class="page-section bg-light" id="portfolio">
			<div class="container">
				<div class="text-center">
					...
					<h3 class="section-subheading text-muted">배워보고 싶었던 다양한 수업을 하루동안 체험할 수 있습니다.</h3>
				</div>
				<div class="row">
...
<!-- 							</a> -->
							<div class="portfolio-caption">
								...
								<div class="portfolio-caption-subheading text-muted">#꾸안꾸 #OOTD #패션클래스</div>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-sm-6 mb-4">
...
<!-- 							</a> -->
							<div class="portfolio-caption">
								...
								<div class="portfolio-caption-subheading text-muted">#밖으로 나와 #여행계획 짜는법 </div>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-sm-6 mb-4">
...
<!-- 							</a> -->
							<div class="portfolio-caption">
								...
								<div class="portfolio-caption-subheading text-muted">#목공 클래스 #목재준비완료 #피노키오</div>
							</div>
						</div>
					</div>
...
<!-- 							</a> -->
							<div class="portfolio-caption">
								...
								<div class="portfolio-caption-subheading text-muted">#SNS 팔로워 늘리기 #각종 전자기기 활용법</div>
							</div>
						</div>
					</div>
...
<!-- 							</a> -->
							<div class="portfolio-caption">
								...
								<div class="portfolio-caption-subheading text-muted">프로그램을 통해 웹사이트를 만들고, 디자인할 수 있습니다.</div>
							</div>
						</div>
					</div>
...
<!-- 							</a> -->
							<div class="portfolio-caption">
								<div class="portfolio-caption-heading">mood</div>
								<div class="portfolio-caption-subheading text-muted">#SNS 사진 느낌있게 찍는 법 #팔로워 늘리는 법</div>
							</div>
						</div>
					</div>
				</div>
	...
	<section class="page-section bg-light" id="freeBoard">
			<div class="container">
				<div class="text-center">
					...
					<h3 class="section-subheading text-muted">자유롭게 의견을 나눌 수 있는 공간입니다.</h3>
				</div>
