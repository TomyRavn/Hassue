			...
			<div class="row">
				<div class="col-lg-4 col-sm-6 mb-4">
					<div class="portfolio-item">
						...
						<!-- 									</div> -->
						<!-- 								</div> -->
						<a href="http://localhost:8081/board/readView?bno=101&page=1&perPageNum=10&searchType=&keyword="><img class="img-fluid"
				...
				<div class="col-lg-4 col-sm-6 mb-4">
					<div class="portfolio-item">
						...
						<!-- 									</div> -->
						<!-- 								</div>  -->
						<a href="http://localhost:8081/board/readView?bno=104&page=1&perPageNum=10&searchType=&keyword="><img class="img-fluid"
							src="/resources/assets/img/portfolio/02.2-thumbnail.jpg" alt="" /></a>
						<!-- 							</a> -->
						<div class="portfolio-caption">
							<div class="portfolio-caption-heading">꽃꽂이</div>
							<div class="portfolio-caption-subheading text-muted">#꽃꽂이클래스 #부케 #꽃다발</div>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-sm-6 mb-4">
					<div class="portfolio-item">
						...
						<!-- 									</div> -->
						<!-- 								</div>  -->
						<a href="http://localhost:8081/board/readView?bno=81&page=1&perPageNum=10&searchType=&keyword="><img class="img-fluid"
				...
				<div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
					<div class="portfolio-item">
						...
						<!-- 									</div> -->
						<!-- 								</div>  -->
						<a href="http://localhost:8081/board/readView?bno=102&page=1&perPageNum=10&searchType=&keyword="><img class="img-fluid"
				...
				<div class="col-lg-4 col-sm-6 mb-4 mb-sm-0">
					<div class="portfolio-item">
						...
						<!-- 									</div> -->
						<!-- 								</div>  -->
						<a href="http://localhost:8081/board/readView?bno=94&page=1&perPageNum=10&searchType=&keyword="><img class="img-fluid"
							src="/resources/assets/img/portfolio/05.2-thumbnail.jpg" alt="" /></a>
						<!-- 							</a> -->
						<div class="portfolio-caption">
							<div class="portfolio-caption-heading">실용음악</div>
							<div class="portfolio-caption-subheading text-muted">#band #통기타 #일렉기타 #보컬트레이닝 #RocknRoll</div>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-sm-6">
					<div class="portfolio-item">
						...
						<!-- 									</div> -->
						<!-- 								</div>  -->
						<a href="http://localhost:8081/board/readView?bno=105&page=1&perPageNum=10&searchType=&keyword="><img class="img-fluid"
							src="/resources/assets/img/portfolio/06.1-thumbnail.jpg" alt="" /></a>
						<!-- 							</a> -->
						<div class="portfolio-caption">
							<div class="portfolio-caption-heading">Cooking</div>
							<div class="portfolio-caption-subheading text-muted">#JMTGR #한식 #양식 #중식 #쿠킹클래스  #요리교실</div>
						</div>
					</div>
				</div>
			</div>
