					...
					<tbody>
						<tr>
							<td><label for="title">제목 </label>
								...
								value="${update.title}" class="chk" title="제목을 입력해 주세요." style="width:500px; height:25px;"/></td>
						</tr>
						<tr>
						...
						<tr>
							<td><label for="writer">작성자 </label>&nbsp;<input
								type="text" id="writer" name="writer" value="${member.userId}"
								readonly="readonly" style="width:200px; height:25px;"/></td>
						</tr>
						<tr>
