			...
			<div class="row">
				...
				<div class="col-lg-4 col-sm-6 mb-4">
					<div class="portfolio-item">
						...
						<!-- 								</div>  -->
						<a
							href="http://localhost:8081/board/readView?bno=83&page=1&perPageNum=10&searchType=&keyword="><img
							class="img-fluid"
				...
				<div class="col-lg-4 col-sm-6">
					<div class="portfolio-item">
						...
						<!-- 								</div>  -->
						<a
							href="http://localhost:8081/board/readView?bno=60&page=1&perPageNum=10&searchType=&keyword="><img
							class="img-fluid"
